...
import com.folu.jejakkaki.databinding.ActivityMapSulawesiBinding
...
class MapSulawesiActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMapSulawesiBinding.inflate(layoutInflater)
