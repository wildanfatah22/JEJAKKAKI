...
import com.folu.jejakkaki.databinding.ActivityMapBaliBinding
...
class MapBaliActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMapBaliBinding.inflate(layoutInflater)
