...
import com.folu.jejakkaki.databinding.ActivityMapSumatraBinding
...
class MapSumatraActivity : AppCompatActivity() {
    private lateinit var binding: ActivityMapSumatraBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMapSumatraBinding.inflate(layoutInflater)
