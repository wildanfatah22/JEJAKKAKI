...
import com.folu.jejakkaki.databinding.ActivityMapPapuaBinding
...
class MapPapuaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMapPapuaBinding.inflate(layoutInflater)
