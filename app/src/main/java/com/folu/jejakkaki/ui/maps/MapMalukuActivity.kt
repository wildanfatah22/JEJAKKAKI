...
import com.folu.jejakkaki.databinding.ActivityMapMalukuBinding
...
class MapMalukuActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMapMalukuBinding.inflate(layoutInflater)
